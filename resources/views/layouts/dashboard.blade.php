...
<body class="h-full font-sans antialiased text-slate-600">
    ...
    <!-- 1. Barra de Carga Global (Inmediata) -->
    <!-- Se eliminó .delay para feedback instantáneo y se aumentó z-index -->
    ...
    <!-- 2. Indicador Flotante (Toast) - Inmediato -->
    <!-- Se eliminó .delay para que aparezca siempre que se procese algo, incluso abrir un modal -->
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div class="text-left w-full md:w-auto order-2 md:order-1">
                        <p class="text-xs text-gray-500 leading-relaxed">
                            &copy; {{ date('Y') }} <span class="font-medium text-gray-700">SGA CENTU | Academic+</span>. 
