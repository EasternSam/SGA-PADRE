            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @role('Admin')
                        ...
                        <x-nav-link :href="route('admin.finance.dashboard')" :active="request()->routeIs('admin.finance.*')">
                            {{ __('Finanzas') }}
                        </x-nav-link>
                        <x-nav-link :href="route('admin.email-tester')" :active="request()->routeIs('admin.email-tester')">
                            {{ __('Enviar Correos') }}
                        </x-nav-link>
                    @endrole
                    ...
                    @role('Estudiante')
                        ...
                        <x-nav-link :href="route('student.requests')" :active="request()->routeIs('student.requests')">
                            {{ __('Mis Solicitudes') }}
                        </x-nav-link>
                    @endrole
                </div>
