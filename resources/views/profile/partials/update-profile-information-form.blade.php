                ...
                <div>
                    <p class="text-sm mt-2 text-sga-text">
                        ...
                        <form method="POST" action="{{ route('verification.send') }}" class="inline">
                            @csrf
                            <button type="submit" class="underline text-sm text-sga-text-light hover:text-sga-text rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sga-secondary">
