<div class="min-h-screen bg-gray-50/50 pb-12">
    ...
    <div class="bg-white shadow-sm border-b border-gray-200">
        <div class="mx-auto w-full max-w-[95%] px-4 sm:px-6 lg:px-8 py-2">
    ...
    {{-- Contenido Principal --}}
    <div class="mx-auto w-full max-w-[95%] px-4 sm:px-6 lg:px-8 mt-4">
