            ...
            <div class="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl dark:bg-gray-800">
                ...
                @if($generatedToken)
                    <div class="rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 p-4 mb-4">
                        ...
                        <p class="text-[10px] text-green-600 mt-2">⚠️ Copie y entregue estas credenciales al padre/tutor. No se mostrarán de nuevo.</p>
                    </div>
                ...
                @else
                    <form wire:submit="createToken" class="space-y-3">
                        ...
                        @elseif($student_id)
                            <div class="rounded-lg bg-yellow-50 p-3 text-sm text-yellow-800">⚠️ Este estudiante no tiene tutores registrados. Registre uno primero.</div>
                        @endif
