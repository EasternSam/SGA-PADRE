                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach($groupedSubjects[$areaKey] as $subject)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    ...
                                    <td class="px-4 py-2 text-sm font-medium text-gray-900 dark:text-white">{{ $subject->name }}</td>
                ...
                <form wire:submit="save" class="space-y-4">
                    <div class="grid grid-cols-3 gap-4">
                        <div class="col-span-2">
                            ...
                            <input type="text" wire:model="name" placeholder="Ej: Lengua Española" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Código</label>
                            <input type="text" wire:model="code" placeholder="LE" maxlength="10" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white uppercase" />
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Área Curricular</label>
                        <select wire:model="area" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" wire:model="weekly_hours" min="1" max="10" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white" />
                        </div>
                        <div class="flex items-end pb-1">
                            <label class="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300">
                                <input type="checkbox" wire:model="is_core" class="rounded border-gray-300 text-blue-600">
                                Obligatoria
                            </label>
                        </div>
                    </div>
