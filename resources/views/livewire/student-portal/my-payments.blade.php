<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 bg-white min-h-screen">

    {{-- 1. Encabezado Estilo Panel (Minimalista) --}}
    <div class="mb-10 pb-6 border-b border-gray-200 flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
            <h2 class="text-3xl font-bold text-gray-900 tracking-tight">Finanzas</h2>
            <p class="mt-2 text-sm text-gray-500">
                Gestiona tus pagos, visualiza deudas pendientes y descarga tus comprobantes.
            </p>
        </div>
        <div class="flex items-center gap-3">
            <div class="bg-gray-50 border border-gray-200 text-gray-600 px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 shadow-sm">
                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <span @class([
                                        ...
                                        'bg-emerald-50 text-emerald-700 border-emerald-200' => $payment->status === 'Completado',
                                        'bg-amber-50 text-amber-700 border-amber-200' => $payment->status === 'Pendiente',
                                        'bg-red-50 text-red-700 border-red-200' => in_array($payment->status, ['Fallido', 'Rechazado']),
                                    ])>
                                        <span class="w-1.5 h-1.5 rounded-full mr-1.5 {{ $payment->status === 'Completado' ? 'bg-emerald-500' : ($payment->status === 'Pendiente' ? 'bg-amber-500' : 'bg-red-500') }}"></span>
                                        {{ $payment->status }}
                                    </span>
                                </td>
                ...
                <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                    <div class="relative transform overflow-hidden rounded-xl bg-white text-left shadow-2xl transition-all sm:my-8 sm:w-full sm:max-w-lg border border-gray-200" style="margin-top: 28px;">
                        ...
                        <div class="bg-white px-6 py-5 border-b border-gray-100 flex items-center justify-between">
                            ...
                            <button wire:click="closeModal" class="text-gray-400 hover:text-gray-600 p-1 rounded-md hover:bg-gray-100 transition-colors">
                        ...
                        <div class="px-6 py-6 bg-white">
                            {{-- Resumen de Orden --}}
                            <div class="mb-8 bg-gray-50 rounded-lg p-5 border border-gray-200 flex justify-between items-center">
                                <div>
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    ...
                                    <label class="cursor-pointer relative">
                                        ...
                                        <div class="p-4 rounded-lg border border-gray-200 hover:border-gray-300 peer-checked:border-gray-900 peer-checked:ring-1 peer-checked:ring-gray-900 transition-all bg-white flex flex-col items-center gap-2 h-full">
                                            ...
                                            <span class="text-sm font-medium text-gray-600 peer-checked:text-gray-900">Tarjeta Crédito/Débito</span>
                                        </div>
                                ...
                                @if($paymentMethod === 'card')
                                    <div class="space-y-4 animate-fade-in-up">
                                        ...
                                        <div>
                                            ...
                                            <div class="relative">
                                                <input type="text" wire:model="cardNumber" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900 sm:text-sm pl-10 py-2.5 font-mono" placeholder="0000 0000 0000 0000">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input type="text" wire:model="cardExpiry" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900 sm:text-sm py-2.5 text-center font-mono" placeholder="MM/YY">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" wire:model="cardCvc" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-gray-900 focus:ring-gray-900 sm:text-sm py-2.5 text-center font-mono" placeholder="123">
