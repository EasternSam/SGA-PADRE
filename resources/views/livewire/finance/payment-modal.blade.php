                                        ...
                                        @if($ncfType === 'B01')
                                            <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4 animate-fade-in-up bg-indigo-50 p-4 rounded-lg border border-indigo-100">
                                                <div>
                                                    ...
                                                    <div class="flex">
                                                        <input type="text" wire:model="rnc" id="modal_rnc" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-l-md py-2 px-3 disabled:bg-gray-100 disabled:text-gray-500" placeholder="101123456" wire:keydown.enter="lookupRnc" wire:loading.attr="disabled" wire:target="lookupRnc">
                                                        <button type="button" wire:click="lookupRnc" wire:loading.attr="disabled" class="inline-flex items-center px-4 py-2 border border-l-0 border-gray-300 bg-gray-50 text-gray-500 rounded-r-md hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-indigo-500 flex-shrink-0 transition-colors disabled:opacity-50">
                                                            <svg wire:loading.remove wire:target="lookupRnc" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4">
                                                                <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                                                            </svg>
                                                            <svg wire:loading wire:target="lookupRnc" class="animate-spin h-4 w-4 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>
                                                        </button>
                                                    </div>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" wire:model="companyName" id="modal_companyName" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md py-2 px-3 disabled:bg-gray-100 disabled:text-gray-500 cursor-not-allowed" placeholder="Nombre de la empresa" wire:loading.attr="disabled" wire:target="lookupRnc">
