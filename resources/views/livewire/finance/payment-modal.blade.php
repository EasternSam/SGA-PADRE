{{-- 
Modal de Pago con Diseño Premium / Terminal POS (Versión Horizontal Corregida v2)
--}}
<div 
...
>
    <!-- 
      Contenedor Flex para centrado 
      Este contenedor asegura que el modal esté siempre centrado vertical y horizontalmente
    -->
    <div class="flex min-h-screen items-center justify-center p-4 text-center sm:p-0">
        
        <!-- 
          Backdrop (Fondo Oscuro)
          - Fixed inset-0 para cubrir toda la pantalla.
          - Transition para el efecto de desvanecimiento.
        ...
        <!-- 
          Panel del Modal 
          - Relative para estar por encima del backdrop.
          - Transiciones de escala y opacidad para un efecto profesional.
        -->
        <div 
            x-show="show"
            ...
            class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-2xl transition-all w-full max-w-7xl border border-gray-100 my-8 sm:mx-8"
        >
            ...
            <!-- Contenido Principal (Flex Horizontal) -->
                ...
                <div class="w-full lg:w-3/12 bg-gray-50 border-b lg:border-b-0 lg:border-r border-gray-200 p-5 flex flex-col overflow-y-auto">
                    ...
                    <div class="relative mb-4 group shrink-0">
                        ...
                        @if(count($student_results) > 0 && !$student)
                            <ul class="absolute z-20 mt-2 w-full bg-white rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 overflow-hidden max-h-60 overflow-y-auto transform origin-top transition-all left-0">
